...
# fast(er) solution to second half
# did check the output and submitted numbers that seemed to stay
# best for awhile.
...
def step(n, o, t, y, e, yt, et, f, p):
    ...
    # statespace: all open valves + my and elephants position
    key = "".join([k for k in sorted(o_)]) + y + e
